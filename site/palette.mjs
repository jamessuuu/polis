...
export const ENV = {
  light: {
    ...
    'sky-bottom': [0.952, 0.030, 80],
    board: [0.895, 0.030, 70],
    'board-outer': [0.850, 0.026, 68],
    street: [0.810, 0.022, 68],
    'wall-face': [0.495, 0.040, 66],
    'wall-cap': [0.750, 0.030, 68],
